...
$(".audioBtn").click(function(){
    ...
    if(isPlayMusic){
        isPlayMusic = false
        $(".audioBtn").css({'background':'url(imgs/stop.png) no-repeat center center/100% 100%'})
        playBgMusic(false)
    }else{
        isPlayMusic = true
        $(".audioBtn").css({'background':'url(imgs/play.png) no-repeat center center/100% 100%'})
        playBgMusic(true)
    }
})
...
scs.action02 = function () {
    ...
    if(scs.page6clickTimes==1){
        $(".six2").addClass('show').delay(1500).fadeOut();
        return;
    }
    if(scs.page6clickTimes==2){
        $(".six2").hide();
        $(".six3").addClass('show').delay(1500).fadeOut();
        return;
    }
